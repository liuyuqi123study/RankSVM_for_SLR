...
if __name__ == "__main__":
    ...
    # vanilla BERT
    print('vanilla BERT')
    met.pred_path('/Users/yuqi/Library/CloudStorage/GoogleDrive-yuqi5341@gmail.com/我的云端硬盘/CAIL2024/LEVEN-main-2/Downstreams/SCR/SCR-Experiment_me/result/BERT/test_whole')   # path to the predicted files
