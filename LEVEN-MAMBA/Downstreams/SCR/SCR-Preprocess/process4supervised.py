#This file is run on mps device
...
class BertCrfTagging(object):
    def __init__(self,
                 ...
                 checkpoint='/Users/yuqi/Downloads/LEVEN-main/Downstreams/SCR/SCR-Preprocess/saved/checkpoint-1900',
                 max_length=100,
                 batch_size=16,
...
if __name__ == "__main__":
    ...
    #process query data
    model = BertCrfTagging(data_path='/Users/yuqi/Downloads/LEVEN-main/Downstreams/SCR/SCR-Preprocess/input_data/data/query/query.json',
    ...
    #model = BertCrfTagging(data_path='/Users/yuqi/Downloads/LEVEN-main/Downstreams/SCR/SCR-Preprocess/input_data/data/candidates',
