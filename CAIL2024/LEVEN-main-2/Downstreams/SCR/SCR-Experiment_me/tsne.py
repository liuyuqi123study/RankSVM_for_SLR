...
#在这里对第一折的特征进行读取
csvfile_1=pd.read_csv("/Users/yuqi/Downloads/feature_test/features_v2_train_BERT_0902.csv").iloc[:,2:-1]
csvfile_2=pd.read_csv("/Users/yuqi/Downloads/feature_test/features_v2_test_BERT_0902.csv").iloc[:,2:-1]
...
def plot_2d_label(x_1,y_1,x_0,y_0,title,label=None,cmap=None):
    ...
    plt.show()
#n_samples=8512
S_color = pd.read_csv("/Users/yuqi/Downloads/feature_test/features_v2_train_BERT_0902.csv").iloc[:,0]
...
S_color_2=[]
with open ('/Users/yuqi/Downloads/svm_rank/prediction_v2_BERT_0.001_0902_train.txt') as f1:
    for line in f1:
...
score=pd.DataFrame()
j=0
data_1 = pd.read_csv('/Users/yuqi/Library/CloudStorage/GoogleDrive-yuqi5341@gmail.com/我的云端硬盘/CAIL2024/LEVEN-main-2/Downstreams/SCR/SCR-Experiment_me/score_train_BERT_v2.csv')
'''with open('/Users/yuqi/Downloads/feature_test/features_v2_train_BERT_0902.dat') as f:
    for line in f:
                    score.loc[j,'id']=int(line.split('#')[1])
                    score.loc[j,'qid']=int(line[line.find('qid')+4:line.find(':',line.find('qid')+4)-2])
...
#重新获得进行维度转换后的数据
S_color_1_test=pd.read_csv("/Users/yuqi/Downloads/feature_test/features_v2_test_BERT_0902.csv").iloc[:,0]
...
#得到ranksvm的得分
S_color_2_test=[]
with open ('/Users/yuqi/Downloads/svm_rank/prediction_v2_BERT_0.001_0902.txt') as f2:
    for line in f2:
...
j=0
data_2 = pd.read_csv('/Users/yuqi/Library/CloudStorage/GoogleDrive-yuqi5341@gmail.com/我的云端硬盘/CAIL2024/LEVEN-main-2/Downstreams/SCR/SCR-Experiment_me/score_test_BERT_v2.csv')
'''with open('/Users/yuqi/Downloads/feature_test/features_v2_test_BERT_0902.dat') as f:
    for line in f:
                    score_test.loc[j,'id']=int(line.split('#')[1])
                    score_test.loc[j,'qid']=int(line[line.find('qid')+4:line.find(':',line.find('qid')+4)-2])
