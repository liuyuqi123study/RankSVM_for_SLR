...
checkpoint="/content/input/model/1.pkl"
...
for step, data in enumerate(dataset):
    ...
    import json
    fout=open('./features/feature_extraction_Lawformer_train'+str(step)+'.json', "w")
...
for step, data in enumerate(dataset):
    ...
    activation['id']=data['index']
    import json
    fout=open('./features/feature_extraction_Lawformer_test'+str(step)+'.json', "w")
    print(json.dumps(activation), file = fout)
