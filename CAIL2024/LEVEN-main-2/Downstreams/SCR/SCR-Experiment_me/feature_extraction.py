...
for step, data in enumerate(dataset):
    ...
    fout=open('/content/output/features_train/feature_extraction_train_multiclass'+str(step)+'.json', "w")
...
for step, data in enumerate(dataset):
    ...
    fout=open('/content/output/features_train/feature_extraction_test_multiclass'+str(step)+'.json', "w")
    print(json.dumps(activation), file = fout)
