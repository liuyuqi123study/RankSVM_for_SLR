...
import numpy as np
import random
from tools.visual_tool import visual
...
if __name__ == "__main__":
    ...
    parameters = init_all(config, gpu_list, '/content/input/model', "train", local_rank = args.local_rank)#加载模型
    #在这里初始化模型
    do_test = False
    if args.do_test:
        do_test = True
    ...
    visual(parameters,config,gpu_list)
