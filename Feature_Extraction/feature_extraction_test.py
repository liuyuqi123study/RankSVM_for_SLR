...
checkpoint="/content/input/model/3.pkl"
#if len(gpu_list) > 0:
 #   
  ###    else:
...
#try:
 ...
 #       for k,v in parameters["model"].items():
...
for step, data in enumerate(dataset):
    ...
    for key in data.keys():
        ...
        if len(gpu_list) > 0 and key!='index':
    ...
    fout=open('/content/output/features_test/feature_extraction_200_test'+str(step)+'.json', "w")
