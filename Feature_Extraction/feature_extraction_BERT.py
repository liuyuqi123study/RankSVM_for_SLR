...
#checkpoint="/Users/yuqi/Downloads/3.pkl"
...
for step, data in enumerate(dataset):
    ...
    import json
    #fout = open('/Users/yuqi/Downloads/feature_test/feature_extraction_label_130_'+str(step)+'.json', "w")
    fout=open('/content/output/features/feature_extraction_BERT_train'+str(step)+'.json', "w")
...
for step, data in enumerate(dataset):
    ...
    activation['id']=data['index']
    import json
    #fout = open('/Users/yuqi/Downloads/feature_test/feature_extraction_label_500_'+str(step)+'.json', "w")
    fout=open('/content/output/features/feature_extraction_BERT_test'+str(step)+'.json', "w")
    print(json.dumps(activation), file = fout)
